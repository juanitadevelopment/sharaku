...
> **Status:** early release (`0.3.4`). API may still change before `1.0.0`.
...
dependencies {
    ...
    implementation("com.github.juanitadevelopment.sharaku:shazo:0.3.4")
    // optional: embedded/file/server H2 DataSource factory (adds H2)
    implementation("com.github.juanitadevelopment.sharaku:shazo-h2:0.3.4")
    // application runtime (pulls in shazo transitively)
    implementation("com.github.juanitadevelopment.sharaku:backbone:0.3.4")
}
```
